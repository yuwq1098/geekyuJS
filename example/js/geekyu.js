	...
	var DomYu = (function () {
        ...
        DomYu.prototype = {
            ...
            is: function (selector) {
                ...
                if (typeof selector === 'string') {
                    ...
                    if (selector.nodeType || selector instanceof DomYu) {
            ...
            eq: function (index) {
                ...
                if (index < 0) {
                    ...
                    if (returnIndex < 0) return new DomYu([]);
                    else return new DomYu([this[returnIndex]]);
                }
                return new DomYu([this[index]]);
            },
            append: function () {
                var i, j, k, newChild;
                ...
                for (k = 0; k < arguments.length; k++) {
                  ...
                  for (i = 0; i < this.length; i++) {
                      ...
                      else if (newChild instanceof DomYu) {
            ...
            next: function (selector) {
                if (this.length > 0) {
                    if (selector) {
                        if (this[0].nextElementSibling && $(this[0].nextElementSibling).is(selector)) return new DomYu([this[0].nextElementSibling]);
                        else return new DomYu([]);
                    }
                    else {
                        if (this[0].nextElementSibling) return new DomYu([this[0].nextElementSibling]);
                        else return new DomYu([]);
                    }
                }
                else return new DomYu([]);
            ...
            nextAll: function (selector) {
                ...
                return new DomYu(nextEls);
            },
            prev: function (selector) {
                if (this.length > 0) {
                    var el = this[0];
                    if (selector) {
                        if (el.previousElementSibling && $(el.previousElementSibling).is(selector)) return new DomYu([el.previousElementSibling]);
                        else return new DomYu([]);
                    }
                    else {
                        if (el.previousElementSibling) return new DomYu([el.previousElementSibling]);
                        else return new DomYu([]);
                    }
                }
                else return new DomYu([]);
            ...
            find : function (selector) {
                ...
                return new DomYu(foundElements);
            },
            children: function (selector) {
                ...
                return new DomYu($.unique(children));
            },
            remove: function () {
                for (var i = 0; i < this.length; i++) {
        ...
        (function () {
            ...
            function createMethod(name) {
                DomYu.prototype[name] = function (targetSelector, listener, capture) {
                    var i;
        ...
        $.each = function (obj, callback) {
            ...
            // Don't bother continuing without a callback
            if (!callback) return;
            if (Array.isArray(obj) || obj instanceof DomYu) {
                var i;
                // Array
